...
async function bootstrap() {
  ...
  const config = new DocumentBuilder()
    ...
    .setVersion("1.0")
    .addTag("Usuário", "Gestão de acesso e identidade. Inclui autenticação, perfis de utilizador, permissões de nível de conta e preferências de sistema.")
    .addTag("Workspace", "Administração de instâncias de trabalho independentes. Permite configurar diferentes empresas ou unidades de negócio sob a mesma conta SaaS.")
    .addTag("Produto", "Controle operacional de stock. Focado na monitorização de quantidades, registo de entradas (compras/devoluções) e saídas (vendas/perdas) de itens.")
    .build()
